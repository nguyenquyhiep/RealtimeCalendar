...
Route::post('qrLogin', ['uses' => 'QrLoginController@checkUser']);
 ...
 Route::group(['middleware' => ['web', 'auth', 'permission'] ], function () {
        ...
        Route::get('user/{user}/deactivate', ['uses' => 'UserController@deactivate', 'as' => 'user.deactivate']);
         ...
         Route::post('eventspost', 'EventController@store');
     Route::get('calendar', ['uses' => 'EventController@calendar' ]);
     Route::get('/pusher', function () {
         return view('welcomepush');
     });
     Route::get('/send', function () {
         return view('sendmesage');
     });
    // Route::get('/send',['uses' => 'SendMessageController@index' ]);
     Route::post('/postMessage', 'SendMessageController@sendMessage');
        //roles
